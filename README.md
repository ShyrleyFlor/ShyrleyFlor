...
<div style="display: flex; flex-direction: column; align-items: center;">
  ...
  <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 20px;">
    ...
    <div style="text-align: center; width: 80px;">
      <img alt="WordPress" width="60px" src="https://www.vectorlogo.zone/logos/wordpress/wordpress-icon.svg"/>
      <p>WordPress</p>
    </div>
    <div style="text-align: center; width: 80px;">
    ...
    <div style="text-align: center; width: 80px;">
      <img alt="NumPy" width="60px" src="https://seeklogo.com/images/N/numpy-logo-479C24EC79-seeklogo.com.png"/>
      <p>NumPy</p>
    </div>
    <div style="text-align: center; width: 80px;">
      <img alt="Pandas" width="60px" src="https://seeklogo.com/images/P/pandas-icon-logo-BE10401BF1-seeklogo.com.png"/>
      <p>Pandas</p>
    </div>
    <div style="text-align: center; width: 80px;">
